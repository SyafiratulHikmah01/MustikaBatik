				...
				<div class="col-md-7 col-lg-8">
					<div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
						...
						<p class="stext-113 cl6 p-b-26">
							Mustika Batik Banyuwangi merupakan home industri yang memproduksi kain batik asli Banyuwangi
						</p>
						...
						<p class="stext-113 cl6 p-b-26">
							Outlet Mustika Batik Banyuwangi : Krajan, Tamanagung, Cluring Kab.Banyuwangi 68428
						</p>
					</div>
				</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								...
								<span class="stext-105 cl3">
									...
									<!-- <a href="<?php echo base_url()?>User_detail/detail/<?php echo $row->id_produk;?>" class="btn btn-danger">Detail</a> -->
								</span>
							</div>
