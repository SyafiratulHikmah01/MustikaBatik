...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
           ...
           <h2> <p align="center"> Data Testimoni Mustika Batik </p> </h2>
          <!-- Page Heading -->
        
          <!-- Content Row -->
          <div class="row">

            <p> <a href="<?php echo base_url()?>Testimoni/input" class="btn btn-primary"> Tambah Testimoni </a> </p>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> <a href="<?php echo base_url(); ?>Testimoni/delete/<?php echo $row->id;?>" class="btn btn-danger">hapus</a> </td>
      <td> <a href="<?php echo base_url(); ?>Testimoni/edit/<?php echo $row->id;?>" class="btn btn-warning">edit</a> </td>
      </td>
    </tr>
   <?php $no++;
                endforeach;?>
