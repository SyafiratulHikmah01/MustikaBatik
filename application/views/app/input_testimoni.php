...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
           ...
           <h2> <p align="center"> Tambah Data Testimoni </p> </h2>
          <!-- Page Heading -->
    ...
    <form method="POST" action="input" enctype="multipart/form-data">
        ...
        Nama  <br/><input type="text" name="nama" size="150" maxlength="100" value="<?php if(isset($data)) { echo $data[0]->nama; } ?>"><br/><br/>

        Gambar <br/><input type="text" name="gambar" size="150" maxlength="10" value="<?php if(isset($data)) { echo $data[0]->gambar; } ?>"><br/><br/>
        ...
        Deskripsi <br/><input type="text" name="deskripsi" size="150" maxlength="10" value="<?php if(isset($data)) { echo $data[0]->deskripsi; } ?>"><br/><br/>
         ...
         <button> <a href="<?php echo base_url()?>Testimoni/index"> Kembali </button></a>
    </form>
