...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
           ...
           <h2> <p align="center"> Tambah Data Profile </p> </h2>
          <!-- Page Heading -->
    ...
    <form method="POST" action="input" enctype="multipart/form-data">
        ...
        Judul <br/><input type="text" name="judul" size="150" value="<?php if(isset($data)) { echo $data[0]->judul; } ?>"><br/><br/>

        Deskripsi <br/><input type="text" name="deskripsi" size="150" value="<?php if(isset($data)) { echo $data[0]->deskripsi; } ?>"><br/><br/>

        Foto <br/><input type="text" name="foto" size="150" value="<?php if(isset($data)) { echo $data[0]->foto; } ?>"><br/><br/>
